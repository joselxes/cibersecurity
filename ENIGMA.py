...
print("")
plaintext = "AAAAA"  # input("Enter text to encode or decode:\n")
abdc = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
for i in abdc:
    for j in abdc:
        for k in abdc:
            ringPositions = i + j + k
            for l in rotorsXXX:
                for m in rotorsXXX:
                    for n in rotorsXXX:
                        ...
                        # print(ringPositions,rotors,ciphertext)
                        if ciphertext =="BBBBB" or ciphertext == "QYZES":
                            print("\nEncoded text: \n " + ciphertext)
                            print(ringPositions, rotors, ciphertext)
                            # input("Enter text to encode or decode:\n")
# ciphertext = encode(plaintext)
# print("\nEncoded text: \n " + ciphertext)
# print(ringPositions, rotors)
print("fin.")
#enigma implemantation source: https://www.101computing.net/enigma-encoder/
